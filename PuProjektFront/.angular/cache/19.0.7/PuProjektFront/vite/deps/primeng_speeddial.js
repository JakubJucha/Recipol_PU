...
import {
  RouterModule
} from "./chunk-A3DPJUGM.js";
import "./chunk-2LTHHKMQ.js";
import "./chunk-PIZKARKV.js";
import {
  BaseComponent
...
var SpeedDial = class _SpeedDial extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 8,
    vars: 17,
    consts: [["container", ""], ["list", ""], [3, "ngClass", "ngStyle"], [4, "ngIf"], ["role", "menu", 1, "p-speeddial-list", 3, "focus", "focusout", "keydown", "id", "tabindex", "ngStyle"], ["class", "p-speeddial-item", "pTooltip", "", "role", "menuitem", 3, "ngStyle", "tooltipOptions", "ngClass", "id", 4, "ngFor", "ngForOf"], [3, "ngClass", "class", "ngStyle", 4, "ngIf"], ["pButton", "", "pRipple", "", 3, "click", "keydown", "icon", "disabled", "buttonProps"], ["pButtonIcon", "", 4, "ngIf"], [4, "ngTemplateOutlet"], ["pButtonIcon", ""], [4, "ngTemplateOutlet", "ngTemplateOutletContext"], ["pTooltip", "", "role", "menuitem", 1, "p-speeddial-item", 3, "ngStyle", "tooltipOptions", "ngClass", "id"], ["pButton", "", "pRipple", "", "severity", "secondary", "size", "small", "role", "menuitem", 1, "p-speeddial-action", 3, "click", "keydown.enter", "rounded", "icon", "disabled"]],
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(SpeedDial, {
    className: "SpeedDial",
    filePath: "speeddial.ts",
    lineNumber: 125
  });
})();
...
(function() {
  (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(SpeedDialModule, {
    imports: [SpeedDial, SharedModule],
    exports: [SpeedDial, SharedModule]
  });
})();
